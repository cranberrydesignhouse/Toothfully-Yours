        ...
        <div data-testid="implants-restoration-page" className="bg-white">
            ...
            >
                <div className="max-w-7xl mx-auto px-5 md:px-12 lg:px-16 text-left md:text-center">
                    ...
                    <div className="mt-12 md:mt-16 -mx-5 md:mx-0 px-5 md:px-0 flex md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-y-14 md:gap-x-8 overflow-x-auto md:overflow-visible snap-x snap-mandatory md:snap-none pb-4 md:pb-0 scrollbar-none">
                        {SERVICES.map((s, i) => (
                            <Reveal
                                key={s.id}
                                delay={i * 80}
