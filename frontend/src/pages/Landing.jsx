                ...
                <div className="max-w-7xl mx-auto px-5 md:px-12 lg:px-16 grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16 items-center">
                    <div className="md:col-span-6 lg:col-span-6">
                        <Reveal>
                            ...
                            <div className="mt-9 flex items-stretch gap-5 sm:gap-8">
                                <div data-testid="trust-experience" className="text-left">
                                    <p className="font-dmsans font-bold text-[2.1rem] md:text-[2.6rem] text-[#1A1A1A] leading-none tracking-tight">
                                        14+
                                    </p>
                                    <p className="mt-2 font-dmsans text-[0.68rem] md:text-[0.72rem] tracking-[0.18em] uppercase text-[#5C5C5C] leading-tight">
                                        Years Exp.
                                    </p>
                                </div>
                                ...
                                >
                                    <p className="font-dmsans font-bold text-[2.1rem] md:text-[2.6rem] text-[#1A1A1A] leading-none tracking-tight inline-flex items-center gap-1.5">
                                        4.8
                                        <Star
                                            size={26}
                                            fill="#EB8A2C"
                                    ...
                                    <p className="mt-2 font-dmsans text-[0.68rem] md:text-[0.72rem] tracking-[0.18em] uppercase text-[#5C5C5C] leading-tight group-hover:text-[#EB8A2C] transition-colors">
                                        Google Rating
                                    </p>
                                </a>
                                <span className="block w-px self-stretch bg-black/12" />
                                <div data-testid="trust-patients" className="text-left">
                                    <p className="font-dmsans font-bold text-[2.1rem] md:text-[2.6rem] text-[#1A1A1A] leading-none tracking-tight">
                                        6K+
                                    </p>
                                    <p className="mt-2 font-dmsans text-[0.68rem] md:text-[0.72rem] tracking-[0.18em] uppercase text-[#5C5C5C] leading-tight">
                            ...
                            <Reveal key={m.name} delay={i * 100}>
                                ...
                                >
                                    <div className="relative w-52 h-52 md:w-60 md:h-60 rounded-full border-4 border-white shadow-xl bg-[#F5F2EF] overflow-hidden circle-photo">
                                        {i === 1 ? (
                                            <>
                                                {/* Blurred fill so the circle's edges feel continuous */}
                                                <img
                                                    src={m.img}
                                                    alt=""
                                                    aria-hidden="true"
                                                    className="absolute inset-0 w-full h-full object-cover scale-[1.4] blur-2xl opacity-70"
                                                />
                                                {/* Sharp foreground */}
                                                <img
                                                    src={m.img}
