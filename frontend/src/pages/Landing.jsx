                        ...
                        <Reveal>
                            ...
                            <div className="mt-9 flex items-stretch gap-5 sm:gap-7">
                                ...
                                >
                                    ...
                                    <div className="mt-2 font-dmsans text-[0.6rem] md:text-[0.65rem] tracking-[0.2em] uppercase text-[#5C5C5C] leading-tight group-hover:text-[#EB8A2C] transition-colors">
