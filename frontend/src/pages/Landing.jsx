                        ...
                        <Reveal>
                            ...
                            <div className="mt-9 flex items-center gap-5 sm:gap-10">
                                <div data-testid="trust-experience" className="text-left">
                                    <p className="font-dmsans font-bold text-[1.7rem] md:text-[2rem] text-[#1A1A1A] leading-none tracking-tight inline-flex items-baseline">
                                        10+
                                        <span className="font-dmsans font-semibold text-[0.95rem] md:text-[1.05rem] text-[#1A1A1A] tracking-wider ml-1.5">
                                            YRS
                                        </span>
                                    </p>
                                ...
                                >
                                    <p className="font-dmsans font-bold text-[1.7rem] md:text-[2rem] leading-none tracking-tight inline-flex items-center gap-1.5">
                                        <svg
                                            viewBox="0 0 24 24"
                                            className="h-[1.4rem] md:h-[1.55rem] w-auto shrink-0"
                                            aria-label="Google"
                                        >
                                            <path
                                                fill="#4285F4"
