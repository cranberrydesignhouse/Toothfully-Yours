...
const buildSchemas = (page) => {
    ...
    schemas.push({
        ...
        description:
            "Cosmetic, implant, alignment and neuromuscular dental care in Khar West, Mumbai. Led by Dr. Amruta Godbole, DDS (NYU) with two decades of comprehensive dentistry experience.",
        url: SITE_URL,
        logo: LOGO_URL,
...
// Mounts a JSON-LD <script> tag tagged with id ty-schema-jsonld; updates on route change.
export const SeoSchema = ({ page }) => {
    useEffect(() => {
        ...
        return () => {
            // Leave schema in place between routes so crawlers picking up after navigation still see something valid.
        };
    }, [page]);
